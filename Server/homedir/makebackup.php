<?php
$cpaneluser = 'palavpvb'; // cPanel username
$cpaneluserpass = 'RQUacOIzrxkb'; // cPanel password
...
$ftpserver = 'localhost'; // Must be localhost for current server or custom hostname for remote FTP upload
$ftpusername = 'palavpvb'; // cPanel/SFTP username. Should be the same as cPanel username for local upload or custom for remote upload
$ftppassword = 'RQUacOIzrxkb'; // cPanel/SFTP password. Should be the same as cPanel password for local upload or custom for remote upload
$ftpport = '21098'; // SFTP port. Should be 21 in most cases.
$ftpdirectory = '/home/palavpvb/backups'; // Directory on FTP server to store backups. MUST EXIST BEFORE BACKUP OR BACKUP PROCESS WILL FAIL
