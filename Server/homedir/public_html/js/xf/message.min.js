...
d=this;a.errors||a.exception?this.loading=!1:XF.setupHtmlInsert(a.html,function(a,g){a.hide().insertAfter(b);XF.activate(a);d.$editForm=a;a.on("ajax-submit:response",c.proxy(d,"editSubmit"));a.find(".js-cancelButton").on("click",c.proxy(d,"cancelClick"));b.xfFadeUp(null,function(){b.parent().addClass("is-editing");a.xfFadeDown(XF.config.speed.normal,function(){a.trigger("quick-edit:shown");var b=a.find(d.options.editContainer);b.length&&b.get(0).scrollIntoView(!0);d.loading=!1})});a.trigger("quick-edit:show")})},
editSubmit:function(a,b){if(!b.errors&&!b.exception){a.preventDefault();b.message&&XF.flashMessage(b.message,3E3);var c=this.$editorTarget,e=this;XF.setupHtmlInsert(b.html,function(a,d,h){d=e.options.editorTarget;d=d.replace(/<|\|/g,"").replace(/#[a-zA-Z0-9_-]+\s*/,"");var f=a.find(d);f.hide();c.replaceWith(f);e.$editorTarget=f;XF.activate(f);e.stopEditing(!1,function(){f.xfFadeDown();e.$editForm.trigger("quickedit:editcomplete",b)})})}},cancelClick:function(a){this.stopEditing(!0)},stopEditing:function(a,
b){var c=this.$editorTarget,e=this.$editForm,g=this,f=function(){c.parent().removeClass("is-editing");a&&c.xfFadeDown();b&&b();e.remove();g.$editForm=null};e?e.xfFadeUp(null,f):f()}});XF.QuoteClick=XF.Click.newHandler({eventNameSpace:"XFQuoteClick",options:{quoteHref:null,editor:".js-quickReply .js-editor"},init:function(){this.options.quoteHref||console.error("Must be initialized with a data-quote-href attribute.")},click:function(a){a.preventDefault();var b=this.options.quoteHref,d=c(a.target).parents(".tooltip--selectToQuote");
d=XF.unparseBbCode(d.data("quote-html"));XF.ajax("POST",b,{quoteHtml:d},c.proxy(this,"handleAjax"),{skipDefaultSuccess:!0});c(a.target).trigger("s2q:click");a=XF.findRelativeIf(this.options.editor,this.$target);XF.focusEditor(a)},handleAjax:function(a){var b=XF.findRelativeIf(this.options.editor,this.$target);XF.insertIntoEditor(b,a.quoteHtml,a.quote)}});XF.MultiQuote=XF.Element.newHandler({options:{href:"",messageSelector:"",addMessage:"",removeMessage:"",storageKey:""},mqStorage:null,mqOverlay:null,
init:function(){this.initButton();this.initControls()},initButton:function(){this.mqStorage=XF.LocalStorage.getJson(this.options.storageKey);this.hasQuotesStored()&&this.$target.show();this.$target.on("click",c.proxy(this,"buttonClick"))},buttonClick:function(a){a.preventDefault();if(!this.options.href)return console.error("Multi-quote button must have a data-href attribute set to display selected quotes"),!1;XF.ajax("post",this.options.href,{quotes:XF.LocalStorage.get(this.options.storageKey)},c.proxy(this,
"loadOverlay"))},loadOverlay:function(a){if(a.html){var b=this;XF.setupHtmlInsert(a.html,function(a,e){a=XF.getOverlayHtml({html:a,title:e.h1||e.title});a.find(".js-removeMessage").on("click",c.proxy(b,"removeMessage"));a.find(".js-quoteMessages").on("click",c.proxy(b,"quoteMessages"));b.mqOverlay=XF.showOverlay(a)})}},removeMessage:function(a){a.preventDefault();var b=c(a.target).closest(".nestable-item");a=parseInt(b.data("id"));var d=this.mqOverlay;this.removeFromMultiQuote(a);b.xfFadeUp(XF.config.speed.fast,
function(){b.remove()});this.hasQuotesStored()||d.hide()},quoteMessages:function(a){a.preventDefault();a=this.mqOverlay;var b=a.getOverlay();b=c.parseJSON(b.find('input[name="message_ids"]').val());var d=this.mqStorage,e;for(e in b)if(b.hasOwnProperty(e)&&b[e].hasOwnProperty("id")){var g=b[e].id.split("-"),f=g[0];g=g[1];d.hasOwnProperty(f)&&d[f].hasOwnProperty(g)&&(f=d[f][g],!0!==f&&(f=XF.unparseBbCode(f)),b[e].value=f)}a.hide();XF.ajax("post",this.options.href,{insert:b,quotes:XF.LocalStorage.get(this.options.storageKey)},
c.proxy(this,"insertMessages"))},insertMessages:function(a){c.each(a,function(a,b){if(!b.hasOwnProperty("quote")||!b.hasOwnProperty("quoteHtml"))return!0;XF.insertIntoEditor(c(".js-editor").parent(),b.quoteHtml,b.quote)});for(var b in this.mqStorage)this.removeFromMultiQuote(b)},initControls:function(){var a=".tooltip--selectToQuote, "+this.options.messageSelector,b=c(a).find(".js-multiQuote");c(h).on("click",a,c.proxy(this,"controlClick"));var d=this;b.each(function(){var a=c(this),b=a.data("messageId");
...
a+'"]'),d=b.parents(".tooltip--selectToQuote"),e=XF.unparseBbCode(d.data("quote-html"));b.length&&(b.addClass("is-selected"),b.data("mqAction","remove"));this.hasQuotesStored()?this.mqStorage[a]||(this.mqStorage[a]=[]):(this.mqStorage={},this.mqStorage[a]=[]);d.length?this.mqStorage[a].push(e):this.mqStorage[a].push(!0);this.updateMultiQuote()},removeFromMultiQuote:function(a){var b=c('.js-multiQuote[data-message-id="'+a+'"]');b.length&&(b.removeClass("is-selected"),b.data("mqAction","add"));delete this.mqStorage[a];
this.updateMultiQuote()},updateMultiQuote:function(){XF.LocalStorage.setJson(this.options.storageKey,this.mqStorage,!0);this.hasQuotesStored()?this.$target.show():this.$target.hide()},hasQuotesStored:function(){return this.mqStorage&&!c.isEmptyObject(this.mqStorage)}});XF.SelectToQuote=XF.Element.newHandler({options:{messageSelector:""},$quickReply:null,timeout:null,processing:!1,isMouseDown:!1,tooltip:null,tooltipId:null,init:function(){k.getSelection&&(this.options.messageSelector?(this.$quickReply=
c(".js-quickReply .js-editor").parent(),this.$quickReply.length&&(this.$target.on("mousedown",c.proxy(this,"mouseDown")),this.$target.on("mouseup",c.proxy(this,"mouseUp")),c(h).on("selectionchange",c.proxy(this,"selectionChange")))):console.error("No messageSelector"))},mouseDown:function(){this.isMouseDown=!0},mouseUp:function(){this.isMouseDown=!1;this.trigger()},selectionChange:function(){this.isMouseDown||this.trigger()},trigger:function(){this.timeout||this.processing||(this.timeout=setTimeout(c.proxy(this,
"handleSelection"),100))},handleSelection:function(){this.processing=!0;this.timeout=null;var a=k.getSelection(),b=this.getValidSelectionContainer(a);b?this.showQuoteButton(b,a):this.hideQuoteButton();var c=this;setTimeout(function(){c.processing=!1},0)},getValidSelectionContainer:function(a){if(a.isCollapsed||!a.rangeCount)return null;a=a.getRangeAt(0);this.adjustRange(a);if(!c.trim(a.toString()).length&&!a.cloneContents().querySelectorAll("img").length)return null;var b=c(a.commonAncestorContainer).closest(".js-selectToQuote");
return!b.length||!b.closest(this.options.messageSelector).find('.actionBar-action[data-xf-click="quote"]').length||c(a.startContainer).closest(".bbCodeBlock--quote, .js-noSelectToQuote").length||c(a.endContainer).closest(".bbCodeBlock--quote, .js-noSelectToQuote").length?null:b},adjustRange:function(a){var b=!1,d=!1,e=a.endContainer,g=c(e);0==a.endOffset&&(3!=e.nodeType||e.previousSibling||(g=g.parent()),d=0<g.closest(".bbCodeBlock--quote").length);d&&(d=g.closest(".bbCodeBlock--quote"),d.length&&
(a.setEndBefore(d[0]),b=!0));b&&(b=k.getSelection(),b.removeAllRanges(),b.addRange(a))},showQuoteButton:function(a,b){var c=a.xfUniqueId();this.tooltip&&this.tooltipId===c||(this.hideQuoteButton(),this.createButton(a,c));a=this.tooltip.getTooltip();a.data("quote-html",this.getSelectionHtml(b));b=this.getButtonPositionMarker(b);this.tooltip.setPositioner([b.left,b.top]);this.tooltip.isShown()?this.tooltip.reposition():this.tooltip.show();a.addClass("tooltip--selectToQuote")},getButtonPositionMarker:function(a){var b=
c("<span />").text("\u200b");var d=a.getRangeAt(0).cloneRange();a=d.getBoundingClientRect?d.getBoundingClientRect():null;d.collapse(!1);d.insertNode(b[0]);var e=0;do{d=!1;e++;b[0].parentNode&&"js-selectToQuoteEnd"==b[0].parentNode.className&&(b.insertBefore(b[0].parentNode),d=!0);b[0].previousSibling&&3==b[0].previousSibling.nodeType&&0==c.trim(b[0].previousSibling.textContent).length&&(b.insertBefore(b[0].previousSibling),d=!0);if(b[0].parentNode&&"LI"==b[0].parentNode.tagName&&!b[0].previousSibling){var g=
b[0].parentNode;c(g).prev("li").length?(b.appendTo(c(g).prev("li")),d=!0):g.parentNode&&(b.insertBefore(g.parentNode),d=!0)}b[0].parentNode&&!b[0].previousSibling&&-1!=c.inArray(b[0].parentNode.tagName,["DIV","BLOCKQUOTE","PRE"])&&(b.insertBefore(b[0].parentNode),d=!0);b[0].previousSibling&&-1!=c.inArray(b[0].previousSibling.tagName,["OL","UL"])&&(c(b[0].previousSibling).find("li:last").append(b),d=!0);b[0].previousSibling&&-1!=c.inArray(b[0].previousSibling.tagName,["DIV","BLOCKQUOTE","PRE"])&&(b.appendTo(b[0].previousSibling),
d=!0);b[0].previousSibling&&"BR"==b[0].previousSibling.tagName&&(b.insertBefore(b[0].previousSibling),d=!0)}while(d&&5>e);var f=b.offset();d=b.height();b.parentsUntil("body").each(function(){var a=c(this);switch(a.css("overflow-x")){case "hidden":case "scroll":case "auto":var b=a.offset().left;a=b+a.outerWidth();f.left<b&&(f.left=b);a<f.left&&(f.left=a)}});e=b.parent();b.remove();XF.browser.msie||e[0].normalize();a&&!XF.isRtl()&&32<f.left-a.left&&(f.left-=16);f.top+=d;return f},createButton:function(a,
b){var d=a.closest(this.options.messageSelector);a=c("<span />");var e=d.find(".actionBar-action.js-multiQuote").clone();e.length&&(e.attr("title","").removeClass("is-selected").data("mqAction","add").css({marginLeft:0,background:"transparent"}).on("s2q:click",c.proxy(this,"buttonClicked")),a.append(e),a.append(h.createTextNode(" | ")));d=d.find('.actionBar-action[data-xf-click="quote"]').attr("title","").clone().css({marginLeft:0}).on("s2q:click",c.proxy(this,"buttonClicked"));a.append(d);this.tooltip=
new XF.TooltipElement(a,{html:!0,placement:"bottom"});this.tooltipId=b},buttonClicked:function(){var a=k.getSelection();a.isCollapsed||(a.collapse(a.getRangeAt(0).commonAncestorContainer,0),this.hideQuoteButton())},hideQuoteButton:function(){var a=this.tooltip;a&&(a.destroy(),this.tooltip=null)},getSelectionHtml:function(a){var b=h.createElement("div"),c;var e=0;for(c=a.rangeCount;e<c;e++)b.appendChild(a.getRangeAt(e).cloneContents());return this.prepareSelectionHtml(b.innerHTML)},prepareSelectionHtml:function(a){return XF.adjustHtmlForRte(a)}});
XF.QuickReply=XF.Element.newHandler({options:{messageContainer:"",ascending:!0,filesContainer:".js-attachmentFiles",fileRow:".js-attachmentFile",insertAllRow:".js-attachmentInsertAllRow",submitHide:null},init:function(){this.$target.on("ajax-submit:before",c.proxy(this,"beforeSubmit"));this.$target.on("ajax-submit:response",c.proxy(this,"afterSubmit"));this.$target.on("draft:complete",c.proxy(this,"onDraft"))},beforeSubmit:function(a,b){(b=b.submitButton)&&"more_options"==b.attr("name")&&a.preventDefault()},
afterSubmit:function(a,b){if(!b.errors&&!b.exception)if(a.preventDefault(),b.redirect)XF.redirect(b.redirect);else{this.$target.find('input[name="last_date"]').val(b.lastDate);this.getMessagesContainer().find(".js-newMessagesIndicator").remove();this.insertMessages(b.html);XF.clearEditorContent(this.$target);(a=XF.getEditorInContainer(this.$target))&&XF.Editor&&a instanceof XF.Editor&&a.blur();b=this.options;var c=this.$target.find(b.filesContainer);c.length&&(c.removeClass("is-active"),a=c.find(b.insertAllRow),
b=c.find(b.fileRow),a.length&&a.removeClass("is-active"),b.length&&b.remove());this.$target.trigger("preview:hide",[this]);this.options.submitHide&&XF.findRelativeIf(this.options.submitHide,this.$target).hide()}},insertMessages:function(a){XF.Message.insertMessages(a,this.getMessagesContainer(),this.options.ascending,function(a){if((a=a.first())&&a.length){a=a.dimensions();var b=c(k).scrollTop(),e=b+c(k).height();(a.top<b+50||a.top>e)&&c("html, body").animate({scrollTop:Math.max(0,a.top-60)},200)}})},
...
function(a,c,g){a.replaceAll(b.$captchaContainer);g()})},submit:function(a){if(!this.initialized&&!c(h.activeElement).is(this.options.skip))return a.preventDefault(),!1}});XF.PostEdit=XF.Element.newHandler({init:function(){this.$target.on("quickedit:editcomplete",c.proxy(this,"editComplete"))},editComplete:function(a,b){var d=this;XF.setupHtmlInsert(b.html,function(a,g,f){f=b.threadChanges||{};f.title&&(c("h1.p-title-value").html(g.h1),c("title").html(g.title),XF.config.visitorCounts.title_count&&
b.visitor&&(XF.pageTitleCache=g.title,XF.pageTitleCounterUpdate(b.visitor.total_unread)));if(f.customFields){var e=a.closest(".js-threadStatusField"),h=XF.findRelativeIf("< .block--messages | .js-threadStatusField",d.$target);e.length&&h.length&&h.xfFadeUp(XF.config.speed.fast,function(){h.replaceWith(e).xfFadeDown(XF.config.speed.fast)})}else a.find(".js-threadStatusField").remove()})}});XF.MultiQuote=XF.Element.newHandler({options:{href:"",messageSelector:"",addMessage:"",removeMessage:"",storageKey:""},
mqStorage:null,mqOverlay:null,init:function(){this.initButton();this.initControls()},initButton:function(){this.mqStorage=XF.LocalStorage.getJson(this.options.storageKey);this.hasQuotesStored()&&this.$target.show();this.$target.on("click",c.proxy(this,"buttonClick"))},buttonClick:function(a){a.preventDefault();if(!this.options.href)return console.error("Multi-quote button must have a data-href attribute set to display selected quotes"),!1;XF.ajax("post",this.options.href,{quotes:XF.LocalStorage.get(this.options.storageKey)},
c.proxy(this,"loadOverlay"))},loadOverlay:function(a){if(a.html){var b=this;XF.setupHtmlInsert(a.html,function(a,e){a=XF.getOverlayHtml({html:a,title:e.h1||e.title});a.find(".js-removeMessage").on("click",c.proxy(b,"removeMessage"));a.find(".js-quoteMessages").on("click",c.proxy(b,"quoteMessages"));b.mqOverlay=XF.showOverlay(a)})}},removeMessage:function(a){a.preventDefault();var b=c(a.target).closest(".nestable-item");a=parseInt(b.data("id"));var d=this.mqOverlay;this.removeFromMultiQuote(a);b.xfFadeUp(XF.config.speed.fast,
function(){b.remove()});this.hasQuotesStored()||d.hide()},quoteMessages:function(a){a.preventDefault();a=this.mqOverlay;var b=a.getOverlay();b=c.parseJSON(b.find('input[name="message_ids"]').val());var d=this.mqStorage,e;for(e in b)if(b.hasOwnProperty(e)&&b[e].hasOwnProperty("id")){var g=b[e].id.split("-"),f=g[0];g=g[1];d.hasOwnProperty(f)&&d[f].hasOwnProperty(g)&&(f=d[f][g],!0!==f&&(f=XF.unparseBbCode(f)),b[e].value=f)}a.hide();XF.ajax("post",this.options.href,{insert:b,quotes:XF.LocalStorage.get(this.options.storageKey)},
c.proxy(this,"insertMessages"))},insertMessages:function(a){c.each(a,function(a,b){if(!b.hasOwnProperty("quote")||!b.hasOwnProperty("quoteHtml"))return!0;XF.insertIntoEditor(c(".js-editor").parent(),b.quoteHtml,b.quote)});for(var b in this.mqStorage)this.removeFromMultiQuote(b)},initControls:function(){var a=".tooltip--selectToQuote, "+this.options.messageSelector,b=c(a).find(".js-multiQuote");c(h).on("click",a,c.proxy(this,"controlClick"));var d=this;b.each(function(){var a=c(this),b=a.data("messageId");
d.mqStorage.hasOwnProperty(b)&&(a.addClass("is-selected"),a.data("mqAction","remove"))})},controlClick:function(a){if(c(a.target).is(".js-multiQuote")){a.preventDefault();var b=c(a.target),d=b.data("mqAction");b=b.data("messageId");switch(d){case "add":this.addToMultiQuote(b);XF.flashMessage(this.options.addMessage,3E3);break;case "remove":this.removeFromMultiQuote(b),XF.flashMessage(this.options.removeMessage,3E3)}c(a.target).trigger("s2q:click")}},addToMultiQuote:function(a){var b=c('.js-multiQuote[data-message-id="'+
a+'"]'),d=b.parents(".tooltip--selectToQuote"),e=XF.unparseBbCode(d.data("quote-html"));b.length&&(b.addClass("is-selected"),b.data("mqAction","remove"));this.hasQuotesStored()?this.mqStorage[a]||(this.mqStorage[a]=[]):(this.mqStorage={},this.mqStorage[a]=[]);d.length?this.mqStorage[a].push(e):this.mqStorage[a].push(!0);this.updateMultiQuote()},removeFromMultiQuote:function(a){var b=c('.js-multiQuote[data-message-id="'+a+'"]');b.length&&(b.removeClass("is-selected"),b.data("mqAction","add"));delete this.mqStorage[a];
this.updateMultiQuote()},updateMultiQuote:function(){XF.LocalStorage.setJson(this.options.storageKey,this.mqStorage,!0);this.hasQuotesStored()?this.$target.show():this.$target.hide()},hasQuotesStored:function(){return this.mqStorage&&!c.isEmptyObject(this.mqStorage)}});XF.Click.register("message-loader","XF.MessageLoaderClick");XF.Click.register("quick-edit","XF.QuickEditClick");XF.Click.register("quote","XF.QuoteClick");XF.Element.register("multi-quote","XF.MultiQuote");XF.Element.register("select-to-quote",
"XF.SelectToQuote");XF.Element.register("quick-reply","XF.QuickReply");XF.Element.register("guest-captcha","XF.GuestCaptcha");XF.Element.register("post-edit","XF.PostEdit")}(jQuery,window,document);
