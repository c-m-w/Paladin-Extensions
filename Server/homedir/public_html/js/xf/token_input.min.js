 ...
 */
!function(f,g,h,k){XF.TokenInput=XF.Element.newHandler({options:{tokens:[","],minLength:2,maxLength:0,maxTokens:0,selectOnClose:!1,acUrl:""},$container:null,$selection:null,$hiddenInput:null,init:function(){var a=this.$target,b=this.options,c=a.clone().insertAfter(a).prop("type","hidden").removeAttr("data-xf-init").removeAttr("id"),d={tags:!0,width:"100%",containerCssClass:"input",language:XF.TokenInput.Phrases,minimumInputLength:b.minLength,maximumInputLength:b.maxLength,maximumSelectionLength:b.maxTokens,
selectOnClose:b.selectOnClose,disabled:a.prop("disabled")};try{d.tokenSeparators=f.parseJSON(b.tokens)}catch(l){d.tokenSeparators=b.tokens}b.acUrl&&(d.ajax={delay:250,data:XF.proxy(this,"prepareAjax"),transport:XF.proxy(this,"getAjax"),processResults:XF.proxy(this,"processAjax")},d.escapeMarkup=function(a){return a},d.sorter=XF.proxy(this,"sortResults"),d.templateResult=XF.proxy(this,"prepareResults"),d.templateSelection=XF.proxy(this,"prepareSelection"));a.remove();var e=f('<select name="tokens_select" multiple="multiple"></select>').insertBefore(c).select2(d);
c.val()&&(b=c.val().split(",").map(f.trim),f.each(b,function(a,b){f("<option selected>").val(b).text(b).appendTo(e)}),e.trigger("change"));this.$hiddenInput=c;c=e.data("select2");this.$container=c.$container;this.$selection=c.$selection;c.on("results:message",function(a){this.dropdown._resizeDropdown();this.dropdown._positionDropdown()});a.attr("autofocus")&&(e.select2("open"),c.$selection.addClass("is-focused"));a=e.closest(".overlay-container");if(a.length)a.on("overlay:hiding",function(){e.select2("close")});
c.$container.on("focusin focusout",XF.proxy(this,"inputFocusBlur"));e.on("change",XF.proxy(this,"updateInput"))},prepareAjax:function(a){return{q:a.term}},getAjax:function(a,b,c){return XF.ajax("get",this.options.acUrl,a.data,b)},processAjax:function(a,b){return"object"!=typeof a?{}:a},sortResults:function(a){if(1>=a.length)return a;a.hasOwnProperty(0)&&(a[0].hasOwnProperty("q")||a.push(a.shift()));return a},prepareResults:function(a){a.styledText=a.text;if(a.q){var b=new RegExp("("+XF.regexQuote(a.q)+
")","i");a.styledText=XF.htmlspecialchars(a.styledText).replace(b,"<strong>$1</strong>")}else a.disabled||(a.styledText="<strong>"+XF.htmlspecialchars(a.styledText)+"</strong>");b=a.styledText;a.iconHtml&&(b=a.iconHtml+"&nbsp;"+b);return b},prepareSelection:function(a){return XF.htmlspecialchars(a.text)},inputFocusBlur:function(a){switch(a.type){case "focusout":this.$selection.removeClass("is-focused");break;default:this.$selection.addClass("is-focused")}},updateInput:function(a){a=f(a.target);var b=
