...
namespace xenMade\AED\Service\Thread;
...
class CreatorSimple extends \XF\Service\AbstractService
{
    ...
    public function __construct(\XF\App $app, Forum $forum, User $user)
    {
        parent::__construct($app);
        $this->forum = $forum;

        $this->setupDefaults($user);
    }

    protected function setupDefaults(User $user)
    {
