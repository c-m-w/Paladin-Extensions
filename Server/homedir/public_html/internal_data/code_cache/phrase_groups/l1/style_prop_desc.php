<?php
return array (
  'style_prop_desc.ahDW_allUsersList' => '',
  'style_prop_desc.ahDW_channel' => '',
  'style_prop_desc.ahDW_container' => '',
  'style_prop_desc.ahDW_joinServerButton' => '',
  'style_prop_desc.ahDW_user' => '',
  'style_prop_desc.ahDW_userAvatar' => '',
  'style_prop_desc.ahDW_userList' => '',
  'style_prop_desc.ahDW_userPlaying' => '',
  'style_prop_desc.ahDW_userStatus' => '',
  'style_prop_desc.ahDW_userStatusIdle' => '',
  'style_prop_desc.ahDW_userStatusOnline' => '',
  'style_prop_desc.ahDW_usersOnlineText' => '',
  ...
  'style_prop_desc.klEMAudioControls' => '',
  'style_prop_desc.klEMCharCounter' => 'Styling properties for the character counter.',
  'style_prop_desc.klEMHideHidden' => 'Special styling rules for the hide BB codes ([HIDE], [HIDEREPLY], [HIDETHANKS], [HIDEREPLYTHANKS], [HIDEPOSTS]) content in hidden state.',
  'style_prop_desc.klEMHideShown' => 'Special styling rules for the hide BB codes ([HIDE], [HIDEREPLY], [HIDETHANKS], [HIDEREPLYTHANKS], [HIDEPOSTS]) content in shown state.',
  'style_prop_desc.klEMTableAlternatingCell' => 'Extra design for the cells in every 2nd row.',
  'style_prop_desc.klEMTableBlock' => 'Special styling rules for table ([TABLE]) elements.',
  'style_prop_desc.klEMTableCell' => 'Special styling rules for table cell ([TD], [TH]) elements.',
  'style_prop_desc.klEMTableTH' => 'Special styling rules for table header cell ([TH]) elements.',
  'style_prop_desc.klEMVideoAudioControls' => '',
  'style_prop_desc.klEMVideoAudioProgress' => '',
  'style_prop_desc.klEMVideoAudioTooltip' => '',
  'style_prop_desc.klEMVideoControls' => '',
  'style_prop_desc.klEMiSpoiler' => 'Special styling rules for the inline spoiler ([ISPOILER]) container.',
  'style_prop_desc.klEMiSpoilerButton' => 'Special styling rules for the inline spoiler ([ISPOILER]) show/hide toggle button.',
  'style_prop_desc.klEMiSpoilerButtonActive' => 'Special styling rules for the inline spoiler ([ISPOILER]) show/hide toggle button in active state.',
  'style_prop_desc.klEMiSpoilerButtonIcon' => 'Special styling rules for the inline spoiler ([ISPOILER]) show/hide toggle button icon.',
  'style_prop_desc.klEMiSpoilerButtonIconActive' => 'Special styling rules for the inline spoiler ([ISPOILER]) show/hide toggle button icon in active state.',
  'style_prop_desc.klEMiSpoilerButtonTitle' => 'Special styling rules for the inline spoiler ([ISPOILER]) title.',
  'style_prop_desc.klEMiSpoilerContent' => 'Special styling rules for the inline spoiler ([ISPOILER]) content.',
  'style_prop_desc.klEMiSpoilerContentActive' => 'Special styling rules for the inline spoiler ([ISPOILER]) content in active state.',
  'style_prop_desc.kl_amdp_block' => '',
  ...
  'style_prop_desc.originalPosterHighlight' => '',
  'style_prop_desc.originalPosterHighlightPositionDesktop' => '',
  'style_prop_desc.originalPosterHighlightPositionMobile' => '',
  ...
  'style_prop_desc.thMaxReactionsMin' => 'The maximum amount of existing reactions that will be shown before they are turned into a minimal display.',
  'style_prop_desc.thReactionsAnimation' => 'This will enable various animations when reacting to content.',
  'style_prop_desc.thReactionsDivider' => 'The character or word that is between the reaction and its count when viewing the content list.  Leave blank for no divider.',
  'style_prop_desc.thReactionsImageDimensions' => 'This will be applied to all normal images who have enabled using the style properties.',
  'style_prop_desc.th_reactionBar_location_reactions' => 'Choose where you want the reaction bar to display in the content. Currently only utilized for posts.',
  'style_prop_desc.th_reactions__barStyle' => '',
  'style_prop_desc.th_reactions__listItemRightStyle' => 'Styling for the right half of listed reactions',
  'style_prop_desc.th_reactions__listItemStyle' => 'Style of a reaction and it\'s count',
  'style_prop_desc.th_reactions__modalStyle' => 'This is the background of the modal, it is separated from the wrapper for animation reasons',
  'style_prop_desc.th_reactions__modalWrapperStyle' => 'This is a wrapper containing the modal background and content',
  'style_prop_desc.th_reactions__showTitles' => '',
  'style_prop_desc.th_reactions__triggerStyle' => '',
  'style_prop_desc.th_reactions_secondaryTrigger' => 'If this is true, Reactions will show both the default reaction and a secondary trigger to click and expand the list of reactions.  If this is false, the list of reactions can only be accessed hovering / long pressing the default reaction.',
  'style_prop_desc.th_reactions_showOnThreadList' => 'If enabled, will show reactions from the first post on the threadlist',
  'style_prop_desc.th_showReactionsPostbit_displayType_reactions' => '',
  'style_prop_desc.th_showReactionsPostbit_location_reactions' => '',
  'style_prop_desc.th_showReactionsPostbit_reactions' => 'This will show the overall reactions that a user has received in a condensed format.',
  'style_prop_desc.th_triggerImageStyling_reactions' => '',
  'style_prop_desc.th_triggerType_reactions' => 'The type of trigger that should be used for reactions',
  'style_prop_desc.th_triggerValue_reactions' => 'The path to the image, glyph class to be used or the name of the template',
  ...
  'style_prop_desc.xm_defaultPerRow' => 'The default number of items to display per row on XR Product Manager layout pages. This helps define the percentage width of each item container.',
  'style_prop_desc.xm_disableProductCategory' => 'Here you can hide or show product categories.',
  'style_prop_desc.xm_disableResponsiveProductCategory' => 'Here you can hide or show product categories for mobile devices.',
  'style_prop_desc.xm_mediumWidthPerRow' => 'The number of items to display per row on XR Product Manager layout pages when responsive design is at the "medium" width or below. This helps define the percentage width of each item container.',
  'style_prop_desc.xm_narrowWidthPerRow' => 'The number of items to display per row on  XR Product Manager layout pages when responsive design is at the "narrow" width or below. This helps define the percentage width of each item container.',
  'style_prop_desc.xm_productCustomFieldsButtons' => 'This feature allows you to create a link for the custom field to be displayed on the XR Product Manager main page. </br></br>Custom Fields create</br> .../admin.php?product-manager/products/fields/',
  'style_prop_desc.xm_productInfo' => 'Here you can make product info active or passive.',
  'style_prop_desc.xm_productMainFeatures' => 'Here you can make the main features active and passive.',
  'style_prop_desc.xm_productRibbonPrice' => 'Here you can make the price strip active or passive.',
  'style_prop_desc.xm_productRibbonPriceStyle' => '',
  'style_prop_desc.xm_productRibbonPriceStyleBefore' => '',
  'style_prop_desc.xm_productSmallTitle' => 'Here you can make small header information active or passive.',
  'style_prop_desc.xm_productsTitle' => 'Here you can make product titles active or passive.',
  'style_prop_desc.xm_wideWidthPerRow' => 'The number of items to display per row on XR Product Manager layout pages when responsive design is at the "wide" width or below. This helps define the percentage width of each item container.',
  'style_prop_desc.xm_xrCustomFieldsButtonsOpen' => 'How do you turn on your browser\'s links? </br></br>
<b>_blank</b> = Opens the linked document in a new window or tab </br>
<b>_self</b> = Opens the linked document in the same frame as it was clicked (this is default)</br>
<b>_parent</b> = Opens the linke',
  'style_prop_desc.xm_xrImageHoverEffect' => 'Here you can select transition effects for images, which are located on the XR Product Manager main page.',
  'style_prop_desc.xm_xrProductManagerOn' => '<div class="blockMessage blockMessage--success" style="margin: 0 2px;">This option is enable or disable "XR Product Manager Layout" add-on.</div>',
  'style_prop_desc.xrImageHoverEffectColor' => '',
