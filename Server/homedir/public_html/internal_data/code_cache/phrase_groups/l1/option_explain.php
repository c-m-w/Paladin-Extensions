...
/*$(function()
{
  ...
  'option_explain.kLEMVideoCacheRefresh' => 'If a value greater than 0 is entered, images cached by the video proxy will be refreshed after this many days have passed. This can be used in conjunction with a long cache lifetime to allow videos to be updated periodically while retaining resilience against the video being removed. If a value of 0 is entered, videos will only be updated when the cache entry expires.',
  'option_explain.klEMAudioCacheRefresh' => 'If a value greater than 0 is entered, audios cached by the audio proxy will be refreshed after this many days have passed. This can be used in conjunction with a long cache lifetime to allow audios to be updated periodically while retaining resilience against the audio being removed. If a value of 0 is entered, audios will only be updated when the cache entry expires.',
  'option_explain.klEMAudioCacheTTL' => 'Enter the number of days that proxied audios should be retained for, before they are removed from your system. If the audio is re-requested after this time, it will automatically be fetched again. Use 0 to retain the audios indefinitely.',
  'option_explain.klEMAudioProxyMaxSize' => 'This is the maximum file size for audios that are displayed through the audio proxy system. An audio larger than this will return a placeholder audio instead. You may use 0 to disable the limit.',
  'option_explain.klEMColorStep' => 'The number of colors per row in the editor color select dropdown.',
  'option_explain.klEMColors' => 'The set of available colors to pick from using the color picker dropdown. To remove a color, leave the value empty. The REMOVE button will automatically be added to the end of the list.',
  'option_explain.klEMDefaultHide' => 'The hide-version the default [hide] code will act like.',
  'option_explain.klEMEnabledBBCodes' => '',
  'option_explain.klEMExternalFontPolling' => 'If enabled, users that have been granted the permission will be able to utilize the whole Google Fonts library in their BB code content, no matter if they have been integrated into your web page or not. If they\'re not already included, they will be loaded on demand.',
  'option_explain.klEMFontSizes' => 'Available sizes in the editor font size dropdown, separated by comma.',
  'option_explain.klEMGeneralOptions' => '',
  'option_explain.klEMGoogleApiKey' => 'If you enter a Google Font API key here, your board will be able to automatically update the google fonts list by itself once a week and provider your users with suggestions when they search for a google font in the BB Code editor.',
  'option_explain.klEMHexColor' => 'If enabled, will show a hex color code input, allowing users to chose their own text color.',
  'option_explain.klEMHideControllers' => '<strong>This is an advanced option.</strong> It is recommended to only edit it if you know exactly what you\'re doing. Adding controllers here will not make the hide BB code magically work on non-forum routes, but allows you to add additional controllers from 3rd party add-ons that add functionality to threads where the hide Bb code will not be hidden. One entry per line.',
  'option_explain.klEMImageAlignment' => 'When enabled, the image Bb Code will support optional parameters that allows people to align the images they include into their posts manually.',
  'option_explain.klEMImageDimensions' => 'When enabled, the image Bb Code will support optional parameters that allows people to resize the images they include into their posts manually.',
  'option_explain.klEMLateLoad' => 'If enabled, a placeholder will be shown and the editor will only load, if the user clicks into the placeholder area. This will speed up page load.',
  'option_explain.klEMLayout' => 'The editor toolbar layout. It is recommended to edit this option from <a href="admin.php?em/layout/">here</a>.',
  'option_explain.klEMMaxFontSize' => 'The maximum font size that can be specified (in pixel). 0 for no limit.',
  'option_explain.klEMMinFontSize' => 'The minimum font size that can be specified (in pixel).',
  'option_explain.klEMProxy' => 'By enabling these options, you may proxy and cache videos and audios posted in messages through your own server, allowing tracking of clicks etc. This is especially important if you are running your site through SSL (HTTPS).',
  'option_explain.klEMVideoAudioProxyLogLength' => 'This option controls the length of time for which the proxy logs will be maintained after the last request made to an audio or a video. If an entry is not requested for this amount of time, its data (including first request time and total accesses) will be removed. Proxy logs will never be removed unless the audio or video data has been removed (Audio/video cache lifetime). Use 0 to disable pruning of the logs.',
  'option_explain.klEMVideoAudioProxyReferrer' => 'If enabled, whenever a proxied audio or video is accessed, referrer information will be maintained. This can be viewed in the logs to determine where the audio or video has been mentioned. Use 0 to keep the referrer data forever.',
  'option_explain.klEMVideoCacheTTL' => 'Enter the number of days that proxied videos should be retained for, before they are removed from your system. If the video is re-requested after this time, it will automatically be fetched again. Use 0 to retain the videos indefinitely.',
  'option_explain.klEMVideoProxyMaxSize' => 'This is the maximum file size for videos that are displayed through the image proxy system. A video larger than this will return a placeholder video instead. You may use 0 to disable the limit.',
