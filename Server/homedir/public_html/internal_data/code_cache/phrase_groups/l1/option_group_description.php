...
return array (
  ...
  'option_group_description.countdown' => 'Options here control the Countdown add-on.',
  'option_group_description.debug' => 'These options are intended to be directly manipulated solely by the XenForo developers.',
  'option_group_description.deletePosts' => 'Options here control the Delete posts add-on.',
...
It is possible to filter the news feed down to just users you follow, or a single user.',
  ...
  'option_group_description.registrationCode' => 'Options here control the Registration code add-on.',
  ...
  'option_group_description.similarThreads' => 'Options here control the Similar threads add-on.',
  'option_group_description.siropuReferralContests' => 'Options for Referral Contests by Siropu.',
  ...
  'option_group_description.userUpgradeReminder' => 'Options here control the User upgrade reminder add-on.',
  'option_group_description.users' => '',
  'option_group_description.usersAndRegistration' => '',
  'option_group_description.xc_login_as_user' => 'Options that control the login as user add-on.',
  'option_group_description.xfrm' => 'Options that control the extension manager add-on.',
);