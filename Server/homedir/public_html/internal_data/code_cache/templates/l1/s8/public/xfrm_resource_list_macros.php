...
return array('macros' => array('resource' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['resource']['prefix_id']) {
		...
		if ($__vars['category']) {
			$__finalCompiled .= '
						<a href="' . $__templater->fn('link', array('resources/categories', $__vars['category'], array('prefix_id' => $__vars['resource']['prefix_id'], ), ), true) . '" class="labelLink">' . $__templater->fn('prefix', array('resource', $__vars['resource'], 'html', '', ), true) . '</a>
					';
		} else {
			$__finalCompiled .= '
