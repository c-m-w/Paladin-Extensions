<?php
// FROM HASH: 4d27e5c70752765a1cd45b37947c32f8
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Inline moderation - Move messages');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Are you sure you want to move ' . $__templater->escape($__vars['total']) . ' message(s) to a new ticket?', array(
		'rowtype' => 'confirm',
	)) . '
