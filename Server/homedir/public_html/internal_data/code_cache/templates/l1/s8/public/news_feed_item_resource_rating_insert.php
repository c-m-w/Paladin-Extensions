...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . '' . $__templater->fn('username_link', array($__vars['user'], false, array('defaultname' => 'Anonymous', ), ), true) . ' reviewed the extension ' . ((((('<a href="' . $__templater->fn('link', array('resources/review', $__vars['content'], ), true)) . '">') . $__templater->fn('prefix', array('resource', $__vars['content']['Resource'], ), true)) . $__templater->escape($__vars['content']['Resource']['title'])) . '</a>') . '.' . '
</div>
