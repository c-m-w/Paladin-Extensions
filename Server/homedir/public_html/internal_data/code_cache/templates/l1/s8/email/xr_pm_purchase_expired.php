...
<br />
Your purchase ' . $__templater->escape($__vars['purchase']['purchase_key']) . ' for ' . $__templater->escape($__vars['product']['product_title']) . ' has expired.<br />
<br />
You will be unable to use this extension until the purchase is renewed.' . '
