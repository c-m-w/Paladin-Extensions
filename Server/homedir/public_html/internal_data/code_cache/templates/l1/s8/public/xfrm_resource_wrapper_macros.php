...
'action_buttons' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['resource'], 'canEdit', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->fn('link', array('resources/edit', $__vars['resource'], ), true) . '" class="menu-linkRow">' . 'Edit extension' . '</a>
								';
	}
	$__compilerTemp3 .= '
								';
	if ($__templater->method($__vars['resource'], 'canEditIcon', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->fn('link', array('resources/edit-icon', $__vars['resource'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Edit extension icon' . '</a>
								';
	}
	$__compilerTemp3 .= '
								';
	if ($__templater->method($__vars['resource'], 'canReleaseUpdate', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->fn('link', array('resources/change-type', $__vars['resource'], ), true) . '" class="menu-linkRow">' . 'Change extension type' . '</a>
								';
	}
	$__compilerTemp3 .= '
								';
	...
	if ($__templater->method($__vars['resource'], 'canMove', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->fn('link', array('resources/move', $__vars['resource'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Move extension' . '</a>
								';
	}
	$__compilerTemp3 .= '
								';
	if ($__templater->method($__vars['resource'], 'canReassign', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->fn('link', array('resources/reassign', $__vars['resource'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Reassign extension' . '</a>
								';
	}
	$__compilerTemp3 .= '
							';
	if ($__templater->method($__vars['resource'], 'canDelete', array('soft', ))) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->fn('link', array('resources/delete', $__vars['resource'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Delete extension' . '</a>
								';
	}
	$__compilerTemp3 .= '
									' . '
