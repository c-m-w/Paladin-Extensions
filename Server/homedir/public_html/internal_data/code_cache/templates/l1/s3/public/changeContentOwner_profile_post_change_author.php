<?php
// FROM HASH: e3d772d11b007fa210ce8823b7233f41
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Change profile post author');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('profile-posts/change-author', $__vars['profilePost'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
