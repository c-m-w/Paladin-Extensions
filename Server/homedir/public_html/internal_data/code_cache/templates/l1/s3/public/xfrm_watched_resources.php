...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Watched extensions');
...
';
	...
	';
		...
		<div class="block-outer">
			...
			<div class="block-outer-opposite">
				' . $__templater->button('Manage watched extensions', array(
			...
			'aria-haspopup' => 'true',
				...
				<div class="menu" data-menu="menu" aria-hidden="true">
					<div class="menu-content">
						<h3 class="menu-header">' . 'Manage watched extensions' . '</h3>
						' . '
						<a href="' . $__templater->fn('link', array('watched/resources/manage', null, array('state' => 'email_subscribe:off', ), ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Disable email notification' . '</a>
						<a href="' . $__templater->fn('link', array('watched/resources/manage', null, array('state' => 'delete', ), ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Stop watching extensions' . '</a>
						' . '
					</div>
				</div>
			</div>
	...
	', array(
			'action' => $__templater->fn('link', array('watched/resources/update', ), false),
			'ajax' => 'true',
			'class' => 'block',
			'autocomplete' => 'off',
		)) . '
';
	...
	<div class="blockMessage">
		...
		';
			...
			$__finalCompiled .= '
			' . 'You are not watching any extensions.' . '
		';
		}
		$__finalCompiled .= '
	</div>
