...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Change extension type');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('resources/change-type', $__vars['resource'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
