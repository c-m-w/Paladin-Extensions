<?php
// FROM HASH: eb26b1eca331a91cc886f2e2043e32e4
...
.typesList
{
	.typesList-type
	{
		...
		&--image::before { .m-faContent(@fa-var-image, 1.08em); ' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'media',
	), $__vars) . '}
		&--video::before { .m-faContent(@fa-var-video-camera, 1em); ' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'video',
	), $__vars) . '}
		&--audio::before { .m-faContent(@fa-var-music, .86em); ' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'audio',
	), $__vars) . '}
		&--embed::before { .m-faContent(@fa-var-cloud-upload, 1.08em); ' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'link',
	), $__vars) . '}
	}
}';
