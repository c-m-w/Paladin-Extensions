...
return array('macros' => array('submit' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canUseSiropuShoutbox', array())) {
		...
		$__finalCompiled .= '
				<button type="submit" class="button button--link" title="' . $__templater->filter('Post', array(array('for_attr', array()),), true) . '" data-xf-init="tooltip"><i class="fa fa-bullhorn" aria-hidden="true"></i></button>
			</span>
		</form>
	';
	}
