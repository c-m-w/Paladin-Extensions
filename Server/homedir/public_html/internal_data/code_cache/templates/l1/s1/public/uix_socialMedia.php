...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['xf']['options']['th_facebookUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_facebookUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_flickrUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_flickrUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_gitHubUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_gitHubUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_instagramUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_instagramUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_linkedInUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_linkedInUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_pinterestUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_pinterestUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_redditUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_redditUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_steamUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_steamUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_tumblrUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_tumblrUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_twitchUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_twitchUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_twitterUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_twitterUrl_uix']) . '">
	...
	if ($__vars['xf']['options']['th_youtubeUrl_uix']) {
		$__finalCompiled .= '
		<li><a href="' . $__templater->escape($__vars['xf']['options']['th_youtubeUrl_uix']) . '">
