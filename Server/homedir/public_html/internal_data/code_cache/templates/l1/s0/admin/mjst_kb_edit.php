<?php
// FROM HASH: ef6c24e9c9f9267492931df5584632a4
...
';
	...
	<div class="block-container">
		...
		'name' => 'username',
		'ac' => 'single',
		'value' => ($__vars['kb']['User'] ? $__vars['kb']['User']['username'] : $__vars['xf']['visitor']['username']),
	), array(
		'label' => 'Creator',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('mjst-support/kb/save', $__vars['kb'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
	return $__finalCompiled;
