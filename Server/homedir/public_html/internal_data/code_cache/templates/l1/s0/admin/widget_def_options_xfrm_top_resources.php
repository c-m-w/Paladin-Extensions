<?php
// FROM HASH: 1fd6004209be961936a45a6a024a645a
...
' . $__templater->formRadioRow(array(
	...
	array(
		'value' => 'full',
		'label' => 'Full',
		'hint' => 'A full size view, displaying as a standard extension list.',
		'_type' => 'option',
	)), array(
		'label' => 'Display style',
	)) . '
...
';
	...
	$__finalCompiled .= $__templater->formSelectRow(array(
		...
		'explain' => 'If no categories are explicitly selected, this widget will pull from all categories unless used within a extension category. In this case, the extensions will be limited to that category and descendents.',
	));
