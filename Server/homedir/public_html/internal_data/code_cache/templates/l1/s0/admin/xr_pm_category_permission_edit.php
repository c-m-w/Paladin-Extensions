<?php
// FROM HASH: e0111aa5c506d2428abb438008a6a5de
...
';
	$__templater->breadcrumb($__templater->preEscaped('Permissions' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['record']['title'])), $__templater->fn('link', array('product-manager/categories/permissions', $__vars['record'], ), false), array(
	));
	$__finalCompiled .= '
