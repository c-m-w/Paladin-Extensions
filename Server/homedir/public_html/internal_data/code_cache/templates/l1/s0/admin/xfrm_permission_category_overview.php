...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Extension category permissions');
	$__finalCompiled .= '
		...
		if ($__templater->isTraversable($__compilerTemp2)) {
			foreach ($__compilerTemp2 AS $__vars['treeEntry']) {
				...
				$__compilerTemp1 .= '
					...
					'_type' => 'cell',
					'html' => '
								<a href="' . $__templater->fn('link', array('permissions/resource-categories', $__vars['category'], ), true) . '">
				...
				array(
					'href' => $__templater->fn('link', array('resource-manager/categories/edit', $__vars['category'], ), false),
					'_type' => 'action',
					'html' => 'Edit',
				))) . '
					';
