<?php
// FROM HASH: f21158191516512135cfdb4aaed0639b
...
'invitation_tabs' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['xf']['visitor'], 'hasPermission', array('siropuReferralContests', 'createInvitations', ))) {
		$__finalCompiled .= '
				<a href="' . $__templater->fn('link', array('account/invitations/create', ), true) . '" class="tabs-tab' . (($__vars['activeTab'] == 'create') ? ' is-active' : '') . '" role="tab" tabindex="0">' . 'Create invitation links' . '</a>
			';
	}
	$__finalCompiled .= '
