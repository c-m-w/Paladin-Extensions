...
';
	if ($__templater->method($__vars['xf']['visitor'], 'canViewResources', array())) {
		$__finalCompiled .= '
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'new_resource') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->fn('link', array('whats-new/resources', ), true) . '" rel="nofollow">' . 'New extensions' . '</a>
';
	}
	$__finalCompiled .= '
