<?php
// FROM HASH: 2075a7ae5eaa0aee73aac405a237d8cc
return array('macros' => array('content' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
	';
	if ($__vars['icon'] == 'support') {
		$__finalCompiled .= 'content: \'@xf-uix_icon_userMultiple\';';
	}
	$__finalCompiled .= '
	';
	if ($__vars['icon'] == 'premium') {
		$__finalCompiled .= 'content: \'@xf-uix_icon_userMultiple\';';
	}
	$__finalCompiled .= '
	';
...
.uix_icon--support:before {content: \'@xf-uix_icon_userMultiple\';}
.uix_icon--premium:before {content: \'@xf-uix_icon_userMultiple\';}
