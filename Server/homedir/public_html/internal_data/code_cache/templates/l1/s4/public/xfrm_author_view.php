...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Extensions by ' . $__templater->escape($__vars['user']['username']) . '');
...
';
	...
	<div class="blockMessage">
		...
		if ($__vars['user']['user_id'] == $__vars['xf']['visitor']['user_id']) {
			$__finalCompiled .= '
			' . 'You have not posted any extensions yet.' . '
		';
		} else {
			$__finalCompiled .= '
			' . '' . $__templater->escape($__vars['user']['username']) . ' has not posted any extensions yet.' . '
		';
		}
		$__finalCompiled .= '
	</div>
