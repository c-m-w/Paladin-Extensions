<?php
// FROM HASH: d3d8b5d97f325dd2e9b0d7c58dbd9691
...
';
	...
	if ($__vars['xf']['options']['xfrmAllowIcons'] AND $__vars['resource']['icon_date']) {
		$__compilerTemp2 .= '
			"thumbnailUrl": "' . $__templater->filter($__templater->fn('resource_icon', array($__vars['resource'], 's', ), false), array(array('escape', array('json', )),), true) . '",
		';
	}
	$__compilerTemp3 = '';
...
';
	...
	if (!$__templater->fn('react_handler_status', array('resource_update', ), false)) {
		$__compilerTemp9 .= '
	';
		if ($__templater->method($__vars['description'], 'canLike', array())) {
			$__compilerTemp9 .= '
											<a href="' . $__templater->fn('link', array('resources/update/like', $__vars['description'], ), true) . '" class="actionBar-action actionBar-action--like" data-xf-click="like" data-like-list="< .js-resourceBody | .js-likeList">';
			if ($__templater->method($__vars['description'], 'isLiked', array())) {
		...
		$__finalCompiled .= '
						<div class="resourceSidebarGroup">
							<h4 class="resourceSidebarGroup-title">
								<a href="' . $__templater->fn('link', array('resources/authors', $__vars['resource']['User'], ), true) . '">' . 'More resources from ' . $__templater->escape($__vars['resource']['User']['username']) . '' . '</a>
							</h4>
