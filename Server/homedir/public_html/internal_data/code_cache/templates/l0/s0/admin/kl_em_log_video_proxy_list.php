<?php
// FROM HASH: ea9ce7b479c91b03ebb99bd37aa1b8a3
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Video proxy log');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('logs/video-proxy', ), false),
		'class' => 'block',
	)) . '
		...
		if ($__templater->isTraversable($__vars['entries'])) {
			foreach ($__vars['entries'] AS $__vars['entry']) {
				...
				$__compilerTemp1 .= $__templater->dataRow(array(
					...
					'href' => $__templater->fn('link', array('logs/video-proxy', $__vars['entry'], ), false),
					'overlay' => 'true',
					'_type' => 'cell',
					'html' => '
