<?php
// FROM HASH: e84f73cb3fc60b6309e22107ec9f1d2f
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Product category permissions');
	$__finalCompiled .= '
...
';
	...
	<div class="block">
		<div class="block-outer">
			...
			'key' => 'product-manager-categories',
		...
		if ($__templater->isTraversable($__compilerTemp2)) {
			foreach ($__compilerTemp2 AS $__vars['treeEntry']) {
				...
				$__compilerTemp1 .= '
					...
					'_type' => 'cell',
					'html' => '
								<a href="' . $__templater->fn('link', array('permissions/product-manager-categories', $__vars['category'], ), true) . '">
				...
				array(
					'href' => $__templater->fn('link', array('product-manager/categories/edit', $__vars['category'], ), false),
					'_type' => 'action',
					'html' => 'Edit',
				))) . '
					';
