<?php
// FROM HASH: 3a74e9c30f06a99d7cd4d7870710f0c6
return array('macros' => array('upload_link' => function($__templater, array $__arguments, array $__vars)
{
	...
	', array(
		'href' => $__templater->fn('link_type', array('public', 'attachments/upload', null, array('type' => $__vars['type'], 'context' => $__vars['context'], 'hash' => $__vars['hash'], ), ), false),
		'target' => '_blank',
...
'upload_link_from_data' => function($__templater, array $__arguments, array $__vars)
{
	...
	' . $__templater->callMacro(null, 'upload_link', array(
		...
		'hash' => $__vars['attachmentData']['hash'],
...
'upload_block' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled = '';
	$__vars = $__templater->mergeMacroArguments(array(
		'initAttachmentManager' => true,
		'attachmentData' => '!',
		'hiddenName' => '!',
		'label' => '',
	), $__arguments, $__vars);
	$__finalCompiled .= '
	<div data-xf-init="' . ($__vars['initAttachmentManager'] ? 'attachment-manager' : '') . '">
