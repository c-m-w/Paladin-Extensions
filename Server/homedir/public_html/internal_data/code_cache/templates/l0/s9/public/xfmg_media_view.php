<?php
// FROM HASH: 27639d20a22be11763b3207516dd4c26
...
<div class="block js-mediaInfoBlock">
					...
					<div class="contentRow-main">
						...
						<div class="contentRow-lesser p-description">
							<ul class="listInline listInline--bullet">
								<li><i class="fa fa-user" title="' . $__templater->filter('xfmg_media_owner', array(array('for_attr', array()),), true) . '" aria-hidden="true"></i> ' . $__templater->fn('username_link', array($__vars['mediaItem']['User'], false, array(
		'defaultname' => $__vars['mediaItem']['username'],
		'class' => 'u-concealed',
	))) . '</li>
								<li><i class="fa fa-clock-o" title="' . $__templater->filter('xfmg_date_added', array(array('for_attr', array()),), true) . '" aria-hidden="true"></i> ' . $__templater->fn('date_dynamic', array($__vars['mediaItem']['media_date'], array(
	))) . '</li>
								';
	if ($__vars['xf']['options']['enableTagging'] AND ($__templater->method($__vars['mediaItem'], 'canEditTags', array()) OR $__vars['mediaItem']['tags'])) {
		$__finalCompiled .= '
									<li><i class="fa fa-tags" title="' . $__templater->filter('Tags', array(array('for_attr', array()),), true) . '"></i>
										';
		if ($__vars['mediaItem']['tags']) {
			$__finalCompiled .= '
											';
		...
		$__finalCompiled .= '
										';
		if ($__templater->method($__vars['mediaItem'], 'canEditTags', array())) {
			$__finalCompiled .= '
											<a href="' . $__templater->fn('link', array('media/tags', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay">' . 'Edit' . '</a>
										';
		}
		$__finalCompiled .= '
									</li>
	...
	$__finalCompiled .= '
		...
		'set' => $__vars['mediaItem']['custom_fields'],
			...
			';
	if (!$__templater->fn('react_handler_status', array('xfmg_media', ), false)) {
		$__finalCompiled .= '
	<div class="likesBar js-likeList' . ($__vars['mediaItem']['likes'] ? ' is-active' : '') . '">
				' . $__templater->fn('likes_content', array($__vars['mediaItem'], $__templater->fn('link', array('media/likes', $__vars['mediaItem'], ), false), array(
			'url' => $__templater->fn('link', array('media/likes', $__vars['mediaItem'], ), false),
		))) . '
			</div>
';
	}
...
';
	...
	if (!$__templater->fn('react_handler_status', array('xfmg_media', ), false)) {
		$__compilerTemp2 .= '
	';
		if ($__templater->method($__vars['mediaItem'], 'canLike', array())) {
			$__compilerTemp2 .= '
										<a href="' . $__templater->fn('link', array('media/like', $__vars['mediaItem'], ), true) . '"
											class="actionBar-action actionBar-action--like"
											data-xf-click="like"
											data-like-list="< .js-mediaInfoBlock | .js-likeList">

											';
			if ($__templater->method($__vars['mediaItem'], 'isLiked', array())) {
