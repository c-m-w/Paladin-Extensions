<?php
// FROM HASH: 4c07c593dbc994449c01d6757157ecf8
...
'uploader' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__vars['inner'] = $__templater->preEscaped('
		' . $__templater->callMacro('xr_pm_attach_upload_macros', 'upload_block', array(
		'attachmentData' => $__vars['attachmentData'],
		'hiddenName' => $__vars['hiddenName'],
	...
	$__vars['inner'] = $__templater->preEscaped('
		<div class="contentRow contentRow--alignMiddle">
			...
			<div class="contentRow-main">
				<a href="' . $__templater->fn('link', array($__vars['link'], $__vars['attachment'], ), true) . '">' . $__templater->escape($__vars['attachment']['filename']) . '</a>
				' . $__compilerTemp2 . '
			</div>
		</div>
	');
