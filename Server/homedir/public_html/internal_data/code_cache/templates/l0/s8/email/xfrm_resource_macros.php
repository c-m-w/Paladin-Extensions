...
return array('macros' => array('go_resource_bar' => function($__templater, array $__arguments, array $__vars)
{
	...
	<tr>
		<td>
			<a href="' . $__templater->fn('link', array('canonical:resources', $__vars['resource'], ), true) . '" class="button">' . 'View this resource' . '</a>
		</td>
		<td align="' . ($__vars['xf']['isRtl'] ? 'left' : 'right') . '">
			';
	if ($__vars['watchType'] == 'resource') {
		$__finalCompiled .= '
				<a href="' . $__templater->fn('link', array('canonical:watched/resources', ), true) . '" class="buttonFake">' . 'Watched resources' . '</a>
			';
