<?php
// FROM HASH: 9d4041304619001d6612852d1c5c06aa
return array('macros' => array('page_link' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['page'] == $__vars['current']) {
		$__finalCompiled .= '
		<li class="pageNav-page pageNav-page--current ' . $__templater->escape($__vars['pageClass']) . '">
			<a href="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . $__templater->escape($__vars['page'])) . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '">' . $__templater->escape($__vars['page']) . '</a>
		</li>
		';
	} else {
		$__finalCompiled .= '
		<li class="pageNav-page ' . $__templater->escape($__vars['pageClass']) . '">
			<a href="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . $__templater->escape($__vars['page'])) . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '">' . $__templater->escape($__vars['page']) . '</a>
		</li>
	';
	}
...
'page_jump_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="menu menu--pageJump" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			...
			<div class="menu-row" data-xf-init="page-jump" data-page-url="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . '%page%') . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '">
...
},), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['pages'] > 1) {
		$__finalCompiled .= '
	<nav class="pageNavWrapper pageNavWrapper--' . $__templater->fn('property', array('pageNavStyle', ), true) . ' ' . $__templater->escape($__vars['variantClass']) . '">
		';
		$__vars['total'] = ($__vars['pages'] * $__vars['perPage']);
		$__finalCompiled .= '
		';
		...
		$__finalCompiled .= '
			...
			'link' => $__vars['link'],
			'pageBit' => $__vars['pageBit'],
			'anchor' => $__vars['anchor'],
			'data' => $__vars['data'],
						...
						<li class="pageNav-page pageNav-page--skip pageNav-page--skipStart">
							<a data-xf-init="tooltip" title="' . $__templater->filter('Go to page', array(array('for_attr', array()),), true) . '"
							   ...
							   role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">
								' . $__templater->escape($__vars['xf']['language']['ellipsis']) . '
							</a>
		...
		if ($__vars['current'] > 1) {
			$__finalCompiled .= '
				<a href="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . '1') . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '"
				   class="pageNavSimple-el pageNavSimple-el--first"
				   data-xf-init="tooltip" title="' . $__templater->filter('First', array(array('for_attr', array()),), true) . '">
					<i aria-hidden="true"></i> <span class="u-srOnly">' . 'First' . '</span>
				</a>
				<a href="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . ($__vars['current'] - 1)) . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '" class="pageNavSimple-el pageNavSimple-el--prev">
		...
		if ($__vars['current'] < $__vars['totalPages']) {
			$__finalCompiled .= '
				<a href="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . ($__vars['current'] + 1)) . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '" class="pageNavSimple-el pageNavSimple-el--next">
					' . 'Next' . ' <i aria-hidden="true"></i>
				</a>
				<a href="' . ((($__templater->escape($__vars['link']) . $__templater->escape($__vars['pageBit'])) . $__templater->escape($__vars['totalPages'])) . ($__vars['anchor'] ? ('/#' . $__templater->escape($__vars['anchor'])) : '')) . '"
