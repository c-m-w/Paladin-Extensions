...
<div class="uix_pageWrapper--fixed">
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		' . '"' . $__templater->escape($__vars['xf']['session']['lau_from_name']) . '", you are currently using "' . $__templater->escape($__vars['xf']['session']['lau_to_name']) . '" account. Click <a href="' . $__templater->fn('link', array('logout/lauout', ), true) . '">here</a> to go back to your account.' . '
	</div>
';
	}
	$__finalCompiled .= '
