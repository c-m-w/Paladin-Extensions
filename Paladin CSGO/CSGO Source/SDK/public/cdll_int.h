...
//-----------------------------------------------------------------------------
typedef void (*pfnDemoCustomDataCallback)( unsigned __int8 *pData, size_t iSize );
...
public:
	...
	virtual void PostToolMessage( HTOOLHANDLE hEntity, void *pMsg ) = 0;
};
