...
#include "../../Dependencies/Include/VMProtect/VMProtectSDK.h"
#define TEXTURE_GROUP_LIGHTMAP					    ENC( "Lightmaps"            )
#define TEXTURE_GROUP_WORLD							ENC( "World textures"       )
#define TEXTURE_GROUP_MODEL							ENC( "Model textures"       )
#define TEXTURE_GROUP_VGUI							ENC( "VGUI textures"        )
#define TEXTURE_GROUP_PARTICLE					    ENC( "Particle textures"    )
#define TEXTURE_GROUP_DECAL							ENC( "Decal textures"       )
#define TEXTURE_GROUP_SKYBOX						ENC( "SkyBox textures"      )
#define TEXTURE_GROUP_CLIENT_EFFECTS				ENC( "ClientEffect textures")
#define TEXTURE_GROUP_OTHER							ENC( "Other textures"       )
#define TEXTURE_GROUP_PRECACHED						ENC( "Precached"            )
#define TEXTURE_GROUP_CUBE_MAP						ENC( "CubeMap textures"     )
#define TEXTURE_GROUP_RENDER_TARGET					ENC( "RenderTargets"        )
#define TEXTURE_GROUP_UNACCOUNTED				    ENC( "Unaccounted textures" )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER		    ENC( "Static Vertex"        )
#define TEXTURE_GROUP_STATIC_INDEX_BUFFER			ENC( "Static Indices"       )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_DISP		ENC( "Displacement Verts"   )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_COLOR	ENC( "Lighting Verts"       )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_WORLD	ENC( "World Verts"          )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_MODELS	ENC( "Model Verts"          )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_OTHER	ENC( "Other Verts"          )
#define TEXTURE_GROUP_DYNAMIC_INDEX_BUFFER		    ENC( "Dynamic Indices"      )
#define TEXTURE_GROUP_DYNAMIC_VERTEX_BUFFER			ENC( "Dynamic Verts"        )
#define TEXTURE_GROUP_DEPTH_BUFFER					ENC( "DepthBuffer"          )
#define TEXTURE_GROUP_VIEW_MODEL					ENC( "ViewModel"            )
#define TEXTURE_GROUP_PIXEL_SHADERS					ENC( "Pixel Shaders"        )
#define TEXTURE_GROUP_VERTEX_SHADERS				ENC( "Vertex Shaders"       )
#define TEXTURE_GROUP_RENDER_TARGET_SURFACE			ENC( "RenderTarget Surfaces")
#define TEXTURE_GROUP_MORPH_TARGETS					ENC( "Morph Targets"        )
