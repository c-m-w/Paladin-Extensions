...
template< typename T > inline void CUtlBuffer::GetObject( T *dest )
{
...
template< typename T > inline void CUtlBuffer::GetObjects( T *dest, int count )
{
...
template< typename T > inline void CUtlBuffer::GetTypeBin( T &dest )
{
	if ( CheckGet( sizeof( T ) ) )
	{
		if ( !m_Byteswap.IsSwappingBytes( ) || ( sizeof( T ) == 1 ) )
...
template< > inline void CUtlBuffer::GetTypeBin< float >( float &dest )
{
...
template< typename T > inline void CUtlBuffer::GetType( T &dest, const char *pszFmt )
{
	if ( !IsText( ) )
	{
		GetTypeBin( dest );
...
template< typename T > inline void CUtlBuffer::PutObject( T *src )
{
...
template< typename T > inline void CUtlBuffer::PutObjects( T *src, int count )
{
...
template< typename T > inline void CUtlBuffer::PutTypeBin( T src )
{
	if ( CheckPut( sizeof( T ) ) )
	{
		if ( !m_Byteswap.IsSwappingBytes( ) || ( sizeof( T ) == 1 ) )
...
template< typename T > inline void CUtlBuffer::PutType( T src, const char *pszFmt )
{
	if ( !IsText( ) )
	{
		PutTypeBin( src );
