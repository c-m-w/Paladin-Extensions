...
// Team handlers
	...
	virtual const char* GetFlashlightTextureName( void ) const
	{
		return NULL;
	} // TERROR
	virtual float GetFlashlightFOV( void ) const
	{
		return 0.0f;
	} // TERROR
	virtual float GetFlashlightFarZ( void ) const
	{
		return 0.0f;
	} // TERROR
	virtual float GetFlashlightLinearAtten( void ) const
	{
		return 0.0f;
	} // TERROR
	virtual bool CastsFlashlightShadows( void ) const
	{
		return true;
	} // TERROR
...
// Prediction stuff
	...
	C_BaseEntity* GetViewEntity( void ) const
	{
...
// returns the player name
	...
	const Vector& GetLadderNormal( void ) const
	{
		return m_vecLadderNormal;
	}
	int GetLadderSurfaceProps( void ) const
	{
		return m_ladderSurfaceProps;
	}
...
public:
	...
	const fogplayerparams_t& GetPlayerFog( ) const
	{
		return m_PlayerFog;
	}
