...
namespace Memory
{
	...
	inline const std::vector< std::pair< EFunctions, unsigned > > vecFunctionIndices
	{
		...
		{ FUNCTION_RESET, 16 },
		{ FUNCTION_PRESENT, 17 },
		{ FUNCTION_DRAW_PRIMITIVE, 82 },
		{ FUNCTION_CREATE_MOVE, 24 },
		...
		{ FUNCTION_IS_PLAYER, 155 },
		{ FUNCTION_IS_WEAPON, 163 },
		{ FUNCTION_GET_VIEW_POSITION, 166 },
