...
public:
	...
	static inline pattern_t _ResetPattern = pattern_t( ENC( "CC E9 ? ? ? ? 83 E4 F8 81 EC + 1" ), &pReset, 1 );
	static inline pattern_t _BeginScenePattern = pattern_t( ENC( "5F 5E EB CA CC" ), &pBeginScene, 5 );
	static inline pattern_t _EndScenePattern = pattern_t( ENC( "83 E0 01 5D C2 04 00 CC" ), &pEndScene, 15 );
