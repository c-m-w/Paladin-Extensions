...
namespace PX::Net
{
	...
	std::string PX_API GeneratePostData( const Types::post_data_t& dqPostData );
	...
	std::string PX_API Request( const std::string& strSite, const Types::post_data_t& dqPostData );
