...
namespace PX::UI::Manager
{
	namespace CSGO
	{
		...
		bool PX_API Initialize( )
		{
			...
			return Render::InitializeRenderTarget( pDevice, uDimensions )
					&& InitializeUI( ( "CSGO" ), false, uWindowWidth, uWindowHeight );
		}
	...
	void PX_API SetLayout( )
	{
		...
		Header( ( "Paladin Extensions" ), szNuklearWindowTitle, 102, CSGO::ChangeVisibility, [ ]( )
		{
			exit( 0 );
		} );
	...
	void PX_API LayoutAwareness( int iSubtab )
	{
		...
		switch ( iSubtab )
		{
			...
			case GLOW:
			{
				...
				if ( BeginGroupbox( 200, 150, 500, 220, ( "Players" ) ) )
				{
					static auto iEntity = 0;
					{
						...
						fnSetValue( iEntity, Combobox( 30, ( "Settings" ), dqEntities, iEntity ) );
						EndRow( );
					}

					{
						...
						Checkbox( ( "Enabled" ), &esdConfig._Players[ iEntity ].bEnabled, ( "Enable glow." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Enabled" ), 30 ).x - COLOR_BUTTON_PADDING * 6 - COLOR_BUTTON_WIDTH * 3 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Glow Visible" ), &esdConfig._Players[ iEntity ].seqColor[ STATE_VISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Glow Invisible" ), &esdConfig._Players[ iEntity ].seqColor[ STATE_INVISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Glow Dormant" ), &esdConfig._Players[ iEntity ].seqColor[ STATE_DORMANT ], COLOR_BUTTON_VERTICAL_PADDING );
...

					{
						...
						Checkbox( ( "Health Based Color" ), &esdConfig._Players[ iEntity ].bHealthBasedColor, ( "Use health to calculate the color." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Health Based Color" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Full Bloom" ), &esdConfig._Players[ iEntity ].bFullBloom, ( "Apply full bloom to the entity." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Full Bloom" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Smoke Check" ), &esdConfig._Players[ iEntity ].bMindSmoke, ( "Check to see if the entity is behind a smoke grenade. " ) );
...

					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( esdConfig._Players[ iEntity ].iGlowStyle, Combobox( 30, ( "Glow Style" ), dqGlowStyles, esdConfig._Players[ iEntity ].iGlowStyle ) );
...

					{
						...
						esdConfig._Players[ iEntity ].flFullBloomAmount = Slider( ( "Fullbloom Amount" ), szFullbloomAmount, 0.f, 1.f, esdConfig._Players[ iEntity ].flFullBloomAmount, 15, 0, GROUPBOX_COLUMN_WIDTH, 30, 1 );
				...
				if ( BeginGroupbox( 400, 315, 500, 220, ( "Entities" ) ) )
				{
					static auto uEntity = 0u;
					{
						...
						TabbedCombobox( 30, ( "Settings" ), dqTabs, dqItems, uEntity );
						EndRow( );
					}

					{
						...
						Checkbox( ( "Enabled" ), &esdConfig._Entities[ uEntity ].bEnabled, ( "Enable glow." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Enabled" ), 30 ).x - COLOR_BUTTON_PADDING * 4 - COLOR_BUTTON_WIDTH * 2 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Glow Visible" ), &esdConfig._Entities[ uEntity ].seqColor[ STATE_VISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Glow Invisible" ), &esdConfig._Entities[ uEntity ].seqColor[ STATE_INVISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
...

					{
						...
						Checkbox( ( "Full Bloom" ), &esdConfig._Entities[ uEntity ].bFullBloom, ( "Apply full bloom to the entity." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Full Bloom" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Smoke Check" ), &esdConfig._Entities[ uEntity ].bMindSmoke, ( "Check if the entity is behind a smoke grenade." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Smoke Check" ), 30 ).x );
						Spacing( );

						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( esdConfig._Entities[ uEntity ].iGlowStyle, Combobox( 30, ( "Glow Style" ), dqGlowStyles, esdConfig._Entities[ uEntity ].iGlowStyle ) );
...

					{
						...
						esdConfig._Entities[ uEntity ].flFullBloomAmount = Slider( ( "Fullbloom Amount" ), szFullbloomAmount, 0.f, 1.f, esdConfig._Entities[ uEntity ].flFullBloomAmount, 15, 0, GROUPBOX_COLUMN_WIDTH, 30, 1 );
			...
			case MATERIALS:
			{
				...
				if ( BeginGroupbox( 200, 150, 500, 220, ( "Entities" ) ) )
				{
					static auto uEntity = 0u;
					{
						std::deque< cstr_t > dqTabs
...

					{
						...
						Checkbox( ( "Enabled" ), &esdConfig._Entities[ uEntity ].bEnabled, ( "Enable materials." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Enabled" ), 30 ).x - COLOR_BUTTON_PADDING * 6 - COLOR_BUTTON_WIDTH * 3 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Material Visible" ), &esdConfig._Entities[ uEntity ].seqColor[ STATE_VISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Material Invisible" ), &esdConfig._Entities[ uEntity ].seqColor[ STATE_INVISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Material Dormant" ), &esdConfig._Entities[ uEntity ].seqColor[ STATE_DORMANT ], COLOR_BUTTON_VERTICAL_PADDING );
...

					{
						...
						Checkbox( ( "Wireframe" ), &esdConfig._Entities[ uEntity ].bWireFrame, ( "Render the material with a wireframe texture." ) );
...

					{
						...
						Checkbox( ( "Wireframe Overlay" ), &esdConfig._Entities[ uEntity ].bWireFrameOverlay, ( "Render a wireframe material overtop of the entity." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH * 3.f / 2.f - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Wireframe Overlay" ), 30 ).x - COLOR_BUTTON_PADDING * 6 - COLOR_BUTTON_WIDTH * 3 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Wireframe Overlay Visible" ), &esdConfig._Entities[ uEntity ].seqWireFrameOverlay[ STATE_VISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Wireframe Overlay Invisible" ), &esdConfig._Entities[ uEntity ].seqWireFrameOverlay[ STATE_INVISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Wireframe Overlay Dormant" ), &esdConfig._Entities[ uEntity ].seqWireFrameOverlay[ STATE_DORMANT ], COLOR_BUTTON_VERTICAL_PADDING );

						Checkbox( ( "Wireframe Underlay" ), &esdConfig._Entities[ uEntity ].bWireFrameUnderlay, ( "Render a wireframe material under the entity, creating an outline effect." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH * 3.f / 2.f - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Wireframe Underlay" ), 30 ).x - COLOR_BUTTON_PADDING * 6 - COLOR_BUTTON_WIDTH * 3 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Wireframe Overlay Visible" ), &esdConfig._Entities[ uEntity ].seqWireFrameUnderlay[ STATE_VISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Wireframe Overlay Invisible" ), &esdConfig._Entities[ uEntity ].seqWireFrameUnderlay[ STATE_INVISIBLE ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Wireframe Overlay Dormant" ), &esdConfig._Entities[ uEntity ].seqWireFrameUnderlay[ STATE_DORMANT ], COLOR_BUTTON_VERTICAL_PADDING );
...

					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( esdConfig._Entities[ uEntity ].iMaterial, Combobox( 30, ( "Material" ), dqMaterials, esdConfig._Entities[ uEntity ].iMaterial ) );
	...
	void PX_API LayoutCombat( int iSubtab )
	{
		...
		switch ( iSubtab )
		{
			case TRIGGER:
			{
				...
				{
					{
						...
						Checkbox( ( "Teammates" ), &pConfig->bTeammates, ( "Fire at teammates." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Teammates" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Enemies" ), &pConfig->bEnemies, ( "Fire at enemies." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Enemies" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Mind Smoke" ), &pConfig->bMindSmoke, ( "Don't shoot through the smoke." ) );
...

					{
						...
						ComboboxMulti( 30, ( "Hitgroups" ), dqHitgroupText, dqHitgroups );

						pConfig->flHitChance = Slider( ( "Hitchance" ), szHitchance, 0.00f, 1.00f, pConfig->flHitChance, GROUPBOX_COLUMN_WIDTH + 30, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );

						pConfig->iRays = Slider( ( "Rays" ), szRays, 100, 255, pConfig->iRays, GROUPBOX_COLUMN_WIDTH * 2 + 40, 10, GROUPBOX_COLUMN_WIDTH, 30 );

						EndRow( );
					}
				};

				if ( BeginGroupbox( 200, 150, 500, 113, ( "Global Configuration" ) ) )
				{
				...
				if ( BeginGroupbox( 400, 206, 500, 158, ( "Group Configurations" ) ) )
				{
					static char szHitchance[ 32 ] { }, szRays[ 32 ] { };
					static int iWeaponGroup = WEAPONTYPE_PISTOL;
					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( iWeaponGroup, Combobox( 30, ( "Group" ), dqTypes, iWeaponGroup ) );

						SetRowWidth( -1.f );
						Spacing( );

						Checkbox( ( "Use Group Configuration" ), &_Settings._Combat._Trigger._WeaponTypes[ iWeaponGroup ].bUseSeparate, ( "Use the weapon group rather than the global setting." ) );
				...
				if ( BeginGroupbox( 400, 350, 500, 190, ( "Weapon Configurations" ) ) )
				{
					static char szHitchance[ 32 ] { }, szRays[ 32 ] { };
...

					{
						...
						TabbedCombobox( 30, ( "Weapons" ), dqComboboxHeaderTypes, dqWeapons, uCurrentWeapon );
...

					{
						...
						Checkbox( ( "Use Weapon Configuration" ), &_Settings._Combat._Trigger._IndividualWeapons[ ITEM_DEFINITION_INDICIES[ uCurrentWeapon ] ].bUseSeparate, ( "Use the weapon's configuration rather than the group or global configuration." ) );
			...
			case AIM:
			{
				...
				{
					{
						...
						Checkbox( ( "Mind Smoke" ), &pConfig->bMindSmoke, ( "Don't aim through the smoke." ) );
...

					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						TabbedComboboxMulti( 30, ( "Hitboxes" ), dqHitboxTabs, dqHitboxText, dqHitboxes, uCurrentTab );

						SetRowWidth( 5 );
						Spacing( );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( pConfig->iAimType, Combobox( 30, ( "Aim Type" ), dqAimTypes, pConfig->iAimType ) );

						SetRowWidth( 5 );
						Spacing( );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( pConfig->iSmoothMode, Combobox( 30, ( "Smooth Mode" ), dqSmoothType, pConfig->iSmoothMode ) );
...

					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( pConfig->iTargeting, Combobox( 30, ( "Targeting" ), dqTargetingModes, pConfig->iTargeting ) );
						SetRowWidth( 5 );
						Spacing( );

						Checkbox( ( "Static Target" ), &pConfig->bStaticTarget, ( "Keep the same target until aimbot is re-activated." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CalculateTextBounds( ( "Static Target" ), 30 ).x - CHECKBOX_ICON_WIDTH );
						Spacing( );

						Checkbox( ( "Validate Target" ), &pConfig->bValidateTarget, ( "Ensure the target is within valid activation parameters after selection. Only applies when Static Target is enabled." ) );
					}

					{
						BeginRow( 30, 9, ROW_CUSTOM );

						pConfig->flAimTime = Slider( ( "Aim Time" ), szSmoothFactor, 0.01f, 1.50f, pConfig->flAimTime, 10, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );

						pConfig->flAimAcceleration = Slider( ( "Acceleration Factor" ), szSmoothFactor, -0.75f, 1.50f, pConfig->flAimAcceleration, GROUPBOX_COLUMN_WIDTH + 30, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );

						pConfig->flMaxCrosshairDistance = Slider( ( "Max Distance" ), szCrosshairDistance, 0.f, 254.558441227f, pConfig->flMaxCrosshairDistance, GROUPBOX_COLUMN_WIDTH * 2 + 40, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );
...

					{
						...
						pConfig->flOverCompensation = Slider( ( "Over Compensation" ), szOverCompensation, 0.f, 5.f, pConfig->flOverCompensation, 10, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );
...

					{
						...
						fnSetValue( iSelectedOrder, IncrementalCombobox( 30, ( "Bezier Orders" ), dqOrders, pConfig->iCurrentOrders, 7, iSelectedOrder ) );
						auto &pCurrentOrder = pConfig->_BezierOrders[ iSelectedOrder ];

						pCurrentOrder.flBisectionPoint = Slider( ( "Bisection Point" ), szBisection, 0.01f, 1.50f, pCurrentOrder.flBisectionPoint, GROUPBOX_COLUMN_WIDTH + 30, 5, GROUPBOX_COLUMN_WIDTH, 30, 2 );

						pCurrentOrder.flDistance = Slider( ( "Distance" ), szDistance, -1.50f, 1.50f, pCurrentOrder.flDistance, GROUPBOX_COLUMN_WIDTH * 2 + 40, 5, GROUPBOX_COLUMN_WIDTH, 30, 2 );
				...
				if ( BeginGroupbox( 200, 150, 500, 250, ( "Global Configuration" ) ) )
				{
				...
				if ( BeginGroupbox( 400, 343, 500, 290, ( "Group Configurations" ) ) )
				{
					static char szSmooth[ 32 ] { }, szCrosshairDistance[ 32 ] { }, szBisect[ 32 ] { }, szDistance[ 32 ] { }, szOverCompensation[ 32 ] { };
					{
						VerticalSpacing( );
						...
						Checkbox( ( "Use Group Configuration" ), &_Settings._Combat._Aim._WeaponTypes[ iWeaponGroup ].bUseSeparate, ( "Use the weapon group rather than the global setting." ) );
				...
				if ( BeginGroupbox( 914, 88, 500, 320, ( "Weapon Configurations" ) ) )
				{
					static char szSmooth[ 32 ] { }, szCrosshairDistance[ 32 ] { }, szBisect[ 32 ] { }, szDistance[ 32 ] { }, szOverCompensation[ 32 ] { };
					{
						VerticalSpacing( );
...

					{
						...
						Checkbox( ( "Use Weapon Configuration" ), &_Settings._Combat._Aim._IndividualWeapons[ ITEM_DEFINITION_INDICIES[ uCurrentWeapon ] ].bUseSeparate, ( "Use the weapon's configuration rather than the group or global configuration." ) );
				...
				if ( BeginGroupbox( 1427, -137, 500, 192, ( "Aim Path Preview" ) ) )
				{
					static auto iConfig = 0;
					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( iConfig, Combobox( 30, ( "Configuration" ), dqConfigs, iConfig ) );
				...
				{
					{
						...
						Checkbox( ( "Enabled" ), &pConfig->bEnabled, ( "Enable compensating for recoil." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CalculateTextBounds( ( "Enabled" ), 30 ).x - CHECKBOX_ICON_WIDTH );
						Spacing( );

						Checkbox( ( "Standalone" ), &pConfig->bStandalone, ( "Compensate for recoil without aimbot. Disable if aimbot is enabled or they will conflict." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CalculateTextBounds( ( "Standalone" ), 30 ).x - CHECKBOX_ICON_WIDTH );
						Spacing( );

						Checkbox( ( "Only When Shooting" ), &pConfig->bNoRefractoryCompensation, ( "Only compensate for recoil while shooting. This will not bring your cursor back to the original position after compensating for recoil has finished." ) );
...

					{
						...
						pConfig->flCompensationAmount = Slider( ( "Compensation Amount" ), szCompensationAmount, 0.f, 1.5f, pConfig->flCompensationAmount, 10, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );

						pConfig->flSmoothness = Slider( ( "Smoothness" ), szCompensationAmount, 0.f, 1.f, pConfig->flSmoothness, 175, 10, GROUPBOX_COLUMN_WIDTH, 30, 3 );

						pConfig->iStartBullet = Slider( ( "Start Compensation at Shot" ), szCompensationAmount, 0, 150, pConfig->iStartBullet, 350, 10, GROUPBOX_COLUMN_WIDTH, 30 );

						EndRow( );
					}
				};

				if ( BeginGroupbox( 200, 150, 500, 220, ( "Global Configuration" ) ) )
				{
	...
	void PX_API LayoutMiscellaneous( int iSubtab )
	{
		...
		switch ( iSubtab )
		{
			case MOVEMENT:
			{
				if ( BeginGroupbox( 200, 150, 500, 220, ( "Movement" ) ) )
				{
...

					{
						...
						Checkbox( ( "Auto Jump" ), &_Settings._Miscellaneous._Movement.bAutomaticJump, ( "Automatically jump." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Auto Jump" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Edge Jump" ), &_Settings._Miscellaneous._Movement.bEdgeJump, ( "Automatically jump when at the edge of a platform." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Edge Jump" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Circle Strafe" ), &_Settings._Miscellaneous._Movement.bCircleStrafe );
...

					{
						...
						_Settings._Miscellaneous._Movement.iMissTicks = Slider( ( "Jump Miss Chance" ), szMissChance, 0, 15, _Settings._Miscellaneous._Movement.iMissTicks, 10, 10, GROUPBOX_COLUMN_WIDTH, 30 );
			...
			case VISUALS:
			{
				if ( BeginGroupbox( 200, 150, 500, 250, ( "Visuals" ) ) )
				{
					{
						BeginRow( 30, 13, ROW_STATIC );
						SetRowWidth( 5 );
						...
						Checkbox( ( "Draw Aim FOV" ), &_Settings._Miscellaneous._Visuals.bDrawAimFOV, ( "Draw a circle to indicate what the boundaries of your aimbot FOV are.") );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Draw Aim FOV" ), 30 ).x - COLOR_BUTTON_PADDING * 4 - COLOR_BUTTON_WIDTH * 2 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Inner Circle" ), &_Settings._Miscellaneous._Visuals.seqAimFOV[ 0 ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Outer Circle" ), &_Settings._Miscellaneous._Visuals.seqAimFOV[ 1 ], COLOR_BUTTON_VERTICAL_PADDING );

						Checkbox( ( "Visualize Spread" ), &_Settings._Miscellaneous._Visuals.bVisualizeSpread, ( "Draw a circle to visualize spread." ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Visualize Spread" ), 30 ).x - COLOR_BUTTON_PADDING * 4 - COLOR_BUTTON_WIDTH * 2 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Inner Circle" ), &_Settings._Miscellaneous._Visuals.seqSpread[ 0 ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Outer Circle" ), &_Settings._Miscellaneous._Visuals.seqSpread[ 1 ], COLOR_BUTTON_VERTICAL_PADDING );

						Checkbox( ( "Darken World" ), &_Settings._Miscellaneous._Visuals.bDarkenWorld, ( "Darken the world." ) );
...

					{
						...
						Checkbox( ( "Modify FOV" ), &_Settings._Miscellaneous._Visuals.bModifyFOV );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Modify FOV" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Bullet Beams" ), &_Settings._Miscellaneous._Visuals.bBulletBeams );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Bullet Beams" ), 30 ).x - COLOR_BUTTON_WIDTH * 2 - COLOR_BUTTON_PADDING * 4 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Bullet Beam Miss" ), &_Settings._Miscellaneous._Visuals.seqBulletBeams[ 0 ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Bullet Beam Hit" ), &_Settings._Miscellaneous._Visuals.seqBulletBeams[ 1 ], COLOR_BUTTON_VERTICAL_PADDING );

						Checkbox( ( "Hitmarkers" ), &_Settings._Miscellaneous._Visuals.bHitmarkers );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Hitmarkers" ), 30 ).x - COLOR_BUTTON_WIDTH * 2 - COLOR_BUTTON_PADDING * 4 );
						Spacing( );
						SetRowWidth( COLOR_BUTTON_WIDTH );
						ColorButton( ( "Hitmarker Team" ), &_Settings._Miscellaneous._Visuals.seqHitmarkers[ 0 ], COLOR_BUTTON_VERTICAL_PADDING );
						ColorButton( ( "Hitmarker Enemy" ), &_Settings._Miscellaneous._Visuals.seqHitmarkers[ 1 ], COLOR_BUTTON_VERTICAL_PADDING );
...

					{
						...
						Checkbox( ( "Fade Hitmarkers" ), &_Settings._Miscellaneous._Visuals.bHitmarkerFade );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Fade Hitmarkers" ), 30 ).x );
						Spacing( );
...

					{
						...
						_Settings._Miscellaneous._Visuals.flViewmodelFOV = Slider( ( "Viewmodel FOV" ), szViewmodelFOV, 0.f, 180.f, _Settings._Miscellaneous._Visuals.flViewmodelFOV, 10, 10, GROUPBOX_COLUMN_WIDTH, 30, 1 );

						_Settings._Miscellaneous._Visuals.flRenderFOV = Slider( ( "Render FOV" ), szRenderFOV, 0.f, 180.f, _Settings._Miscellaneous._Visuals.flRenderFOV, GROUPBOX_COLUMN_WIDTH + 30, 10, GROUPBOX_COLUMN_WIDTH, 30, 1 );

						_Settings._Miscellaneous._Visuals.flHitmarkerLifetime = Slider( ( "Hitmarker Length" ), szHitmarkerLength, 0.1f, 10.f, _Settings._Miscellaneous._Visuals.flHitmarkerLifetime, GROUPBOX_COLUMN_WIDTH * 2 + 40, 10, GROUPBOX_COLUMN_WIDTH, 30, 1 );
...

					{
						...
						_Settings._Miscellaneous._Visuals.flHitmarkerFadeTime = Slider( ( "Hitmarker Fade" ), szHitmarkerFade, 0.f, _Settings._Miscellaneous._Visuals.flHitmarkerLifetime, _Settings._Miscellaneous._Visuals.flHitmarkerFadeTime, 10, 10, GROUPBOX_COLUMN_WIDTH, 30, 1 );
			...
			case INVENTORY:
			{
				...
				if ( BeginGroupbox( 200, 150, 500, 112, ( "Configuration" ) ) )
				{
					static auto iTeam = 0;
					{
						...
						fnSetValue( iTeam, Combobox( 30, ( "Team" ), dqTeams, iTeam ) );
...

					{
						...
						Checkbox( ( "Modify Inventory" ), &pConfig->bModifyInventory );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Modify Inventory" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Modify Knife Model" ), &pConfig->bModifyKnifeModel );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Modify Knife Model" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Modify Glove Model" ), &pConfig->bModifyGloveModel );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Modify Glove Model" ), 30 ).x );
						Spacing( );
				...
				if ( BeginGroupbox( 401, 175, 500, 220, ( "Paint Kits" ) ) )
				{
					{
						VerticalSpacing( );
						...
						TabbedCombobox( 30, ( "Weapons" ), dqCategories, dqWeapons, iSelectedWeapon );
...

					{
						...
						SetRowWidth( flWidth );
						const auto iResult = FilteredCombobox( 30, ( "All Paintkits" ), dqPaintKits, iSelectedPaintKit, 10, szSearch );
						if ( iResult >= 0 )
						{
						...
						if ( TabbedCombobox( 30, ( "Weapon Paintkits" ), dqPages, dqItems, uSelectedWeaponPaintKit ) )
						{
							Miscellaneous::ForceUpdate( );
...

					{
						...
						Checkbox( ( "Souvenir" ), &pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].bSouvenier );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Souvenir" ), 30 ).x );
						Spacing( );

						Checkbox( ( "StatTrak" ), &pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].bStatTrak );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CHECKBOX_ICON_WIDTH - CalculateTextBounds( ( "Souvenir" ), 30 ).x );
						Spacing( );

						Checkbox( ( "Use Custom Name" ), &pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].bUseCustomName );
...

					{
						...
						SetRowWidth( CalculateTextBounds( ( "Name: " ), 30 ).x );
						Text( ( "Name: " ), color_t( { 255, 255, 255, 255 } ) );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH - CalculateTextBounds( ( "Name: " ), 30 ).x );
...

					{
						...
						pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].iStatTrakCounter = Slider( ( "StatTrak" ), szStatTrak, 0, 999999, pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].iStatTrakCounter, 10, 10, GROUPBOX_COLUMN_WIDTH, 30 );

						pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].flWear = Slider( ( "Wear" ), szWear, 0.01f, 1.f, pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].flWear, GROUPBOX_COLUMN_WIDTH + 30, 10, GROUPBOX_COLUMN_WIDTH, 30, 2 );

						pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].iSeed = Slider( ( "Seed" ), szSeed, 0, 1000, pConfig->_PaintKits[ ITEM_DEFINITION_INDICIES[ iSelectedWeapon ] ].iSeed, GROUPBOX_COLUMN_WIDTH * 2 + 40, 10, GROUPBOX_COLUMN_WIDTH, 30 );
				...
				if ( BeginGroupbox( 401, 379, 500, 120, ( "Models" ) ) )
				{
					{
						std::deque< cstr_t > dqPages
						{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						TabbedCombobox( 30, ( "Knife Model" ), dqPages, dqKnives, uSelectedKnife );
						pConfig->_Models.iKnifeModel = Other::GetItemDefinitionIndex( szKnives[ uSelectedKnife ] );

						fnSetValue( iSelectedGlove, Combobox( 30, ( "Glove Model" ), dqGloves, iSelectedGlove ) );
			...
			case OTHER:
			{
				if ( BeginGroupbox( 200, 150, 500, 112, ( "Other" ) ) )
				{
					{
						BeginRow( 30, 3, ROW_STATIC );
						SetRowWidth( 5 );
						...
						Checkbox( ( "Hitsound" ), &_Settings._Miscellaneous._Other.bHitSound );
	...
	void PX_API LayoutSettings( int iSubtab )
	{
		...
		switch ( iSubtab )
		{
			case GLOBAL:
			{
				if ( BeginGroupbox( 200, 150, 500, 112, ( "Global Configuration" ) ) )
				{
					VerticalSpacing( );

					{
						...
						SetFont( FNT_TAHOMA );
						SetRowWidth( CalculateTextBounds( ( "Default Configuration:" ), 30 ).x );
						Text( ( "Default Configuration:" ), color_t( { 255, 255, 255, 255 } ) );
						SetRowWidth( 5 );
						Spacing( );
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						SetFont( FNT_ENVY );
			...
			default:
			{
				if ( BeginGroupbox( 200, 150, 500, 160, ( "Other Configurations" ) ) )
				{
...

					{
						...
						SetRowWidth( GROUPBOX_COLUMN_WIDTH );
						fnSetValue( iSelectedConfig, Combobox( 30, ( "Configs" ), vecMen, iSelectedConfig ) );
...

					{
						...
						if ( Button( EPosition::CENTER, ( "Create Config" ), false, strlen( szNewConfig ) == 0u ) )
