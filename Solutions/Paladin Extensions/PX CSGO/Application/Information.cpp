...
namespace PX::Information
{
	...
	namespace Other
	{
		...
		{
			{
				ITEM_WEAPON_DEAGLE,
				{
					...
					paint_kit_t( 470,PX_XOR( "Sunset Storm" ), GRADE_RESTRICTED, QUALITY_DEFAULT ),
					paint_kit_t( 469,PX_XOR( "Sunset Storm" ), GRADE_RESTRICTED, QUALITY_DEFAULT ),
		...
		{
			const auto pSearch = mpWeaponKits.find( sIndex );
			if ( pSearch != mpWeaponKits.end( ) )
