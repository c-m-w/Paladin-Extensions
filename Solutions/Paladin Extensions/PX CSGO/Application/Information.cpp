		...
		bool PX_API RetrievePaintKits( )
		{
			...
			std::map< short /* item def index */, std::vector< paint_kit_t > /* applicable kits */ > mpWeaponKits
			{
				...
				},
				{
					...
					{
						paint_kit_t( 558, PX_XOR( "Lore" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 568, PX_XOR( "Gamma Doppler [Emerald]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 569, PX_XOR( "Gamma Doppler [Phase 1]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 570, PX_XOR( "Gamma Doppler [Phase 2]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 571, PX_XOR( "Gamma Doppler [Phase 3]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 572, PX_XOR( "Gamma Doppler [Phase 4]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 573, PX_XOR( "Autotronic" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 563, PX_XOR( "Black Laminate" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 580, PX_XOR( "Freehand" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 578, PX_XOR( "Bright Water" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 413, PX_XOR( "Marble Fade" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 415, PX_XOR( "Doppler [Ruby]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 416, PX_XOR( "Doppler [Sapphire]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 417, PX_XOR( "Doppler [Black Pearl]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 418, PX_XOR( "Doppler [Phase 1]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 419, PX_XOR( "Doppler [Phase 2]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 420, PX_XOR( "Doppler [Phase 3]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 421, PX_XOR( "Doppler [Phase 4]" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 409, PX_XOR( "Tiger Tooth" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 98, PX_XOR( "Ultraviolet" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 410, PX_XOR( "Damascus Steel" ), GRADE_KNIFE, QUALITY_STATTRAK ),
						paint_kit_t( 414, PX_XOR( "Rust Coat" ), GRADE_KNIFE, QUALITY_STATTRAK ),
