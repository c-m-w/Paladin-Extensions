...
#define TEXTURE_GROUP_LIGHTMAP					    PX_XOR( "Lightmaps"            )
#define TEXTURE_GROUP_WORLD							PX_XOR( "World textures"       )
#define TEXTURE_GROUP_MODEL							PX_XOR( "Model textures"       )
#define TEXTURE_GROUP_VGUI							PX_XOR( "VGUI textures"        )
#define TEXTURE_GROUP_PARTICLE					    PX_XOR( "Particle textures"    )
#define TEXTURE_GROUP_DECAL							PX_XOR( "Decal textures"       )
#define TEXTURE_GROUP_SKYBOX						PX_XOR( "SkyBox textures"      )
#define TEXTURE_GROUP_CLIENT_EFFECTS				PX_XOR( "ClientEffect textures")
#define TEXTURE_GROUP_OTHER							PX_XOR( "Other textures"       )
#define TEXTURE_GROUP_PRECACHED						PX_XOR( "Precached"            )
#define TEXTURE_GROUP_CUBE_MAP						PX_XOR( "CubeMap textures"     )
#define TEXTURE_GROUP_RENDER_TARGET					PX_XOR( "RenderTargets"        )
#define TEXTURE_GROUP_UNACCOUNTED				    PX_XOR( "Unaccounted textures" )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER		    PX_XOR( "Static Vertex"        )
#define TEXTURE_GROUP_STATIC_INDEX_BUFFER			PX_XOR( "Static Indices"       )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_DISP		PX_XOR( "Displacement Verts"   )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_COLOR	PX_XOR( "Lighting Verts"       )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_WORLD	PX_XOR( "World Verts"          )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_MODELS	PX_XOR( "Model Verts"          )
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_OTHER	PX_XOR( "Other Verts"          )
#define TEXTURE_GROUP_DYNAMIC_INDEX_BUFFER		    PX_XOR( "Dynamic Indices"      )
#define TEXTURE_GROUP_DYNAMIC_VERTEX_BUFFER			PX_XOR( "Dynamic Verts"        )
#define TEXTURE_GROUP_DEPTH_BUFFER					PX_XOR( "DepthBuffer"          )
#define TEXTURE_GROUP_VIEW_MODEL					PX_XOR( "ViewModel"            )
#define TEXTURE_GROUP_PIXEL_SHADERS					PX_XOR( "Pixel Shaders"        )
#define TEXTURE_GROUP_VERTEX_SHADERS				PX_XOR( "Vertex Shaders"       )
#define TEXTURE_GROUP_RENDER_TARGET_SURFACE			PX_XOR( "RenderTarget Surfaces")
#define TEXTURE_GROUP_MORPH_TARGETS					PX_XOR( "Morph Targets"        )
