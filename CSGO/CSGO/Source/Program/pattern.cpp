...
uintptr_t CPatternScanner::FindPattern( char *base, unsigned int size, const char *pattern, char *mask ) // pattern should be const as it's a pointer
{
...
uintptr_t CPatternScanner::FindPatternEx( HANDLE hProcess, char *module, char *pattern, char *mask )
{
	...
	auto start = ( DWORD )modEntry.modBaseAddr; // function-style cast is best here
