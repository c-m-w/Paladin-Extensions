...
public:
	...
	bool bNoFlashState;
	float flNoFlashAlpha;

	bool bRadarState;

	bool bRecoilControlState;
	float flRecoilControlAccuracy_x;
	float flRecoilControlAccuracy_y;
	int iRecoilControlKey;
	...
	bool bAutoShootState;
	int iAutoShootKey;

	bool bFOVState;
	int iFOV;

	bool bWeaponFOVState;
	int iWeaponFOV;
};

extern CFeatureSettings fset;